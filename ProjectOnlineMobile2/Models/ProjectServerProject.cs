...
{
    public class ProjectServerProject
    {
        [JsonProperty("__metadata")]
        public PSP_Metadata PSP_Metadata { get; set; }
        ...
        public object EnterpriseProjectTypeDescription { get; set; }
        ...
        public object ProjectEarlyFinish { get; set; }
        [JsonProperty("ProjectEarlyStart")]
        public object ProjectEarlyStart { get; set; }
        ...
        public object ProjectLateFinish { get; set; }
        [JsonProperty("ProjectLateStart")]
        public object ProjectLateStart { get; set; }
        ...
        [JsonProperty("ProjNo")]
        public object ProjNo { get; set; }
        [JsonProperty("ProjectDescription1")]
        public object ProjectDescription1 { get; set; }
        [JsonProperty("BusinessUnitApprover")]
        public object BusinessUnitApprover { get; set; }
        [JsonProperty("Requestor")]
        public object Requestor { get; set; }
        [JsonProperty("ProjectOwner")]
        public object ProjectOwner { get; set; }
        [JsonProperty("ProgramManager")]
        public object ProgramManager { get; set; }
        [JsonProperty("ROI")]
        public object ROI { get; set; }
        [JsonProperty("ROIDetails")]
        public object ROIDetails { get; set; }
        [JsonProperty("MCReportingProject")]
        public object MCReportingProject { get; set; }
        [JsonProperty("ProjectStatusComments")]
        public object ProjectStatusComments { get; set; }
        [JsonProperty("BusinessGroup")]
        public object BusinessGroup { get; set; }
        [JsonProperty("BusinessLead")]
        public object BusinessLead { get; set; }
        [JsonProperty("BusinessRequestor")]
        public object BusinessRequestor { get; set; }
        [JsonProperty("DateEntered")]
        public object DateEntered { get; set; }
        [JsonProperty("Department")]
        public object Department { get; set; }
        [JsonProperty("HardFinishDate")]
        public object HardFinishDate { get; set; }
        [JsonProperty("HighLevelEst")]
        public object HighLevelEst { get; set; }
        [JsonProperty("InvestmentType")]
        public object InvestmentType { get; set; }
        [JsonProperty("NonLabourCostEst")]
        public object NonLabourCostEst { get; set; }
        [JsonProperty("Objectives")]
        public object Objectives { get; set; }
        [JsonProperty("PMBusiness")]
        public object PMBusiness { get; set; }
        [JsonProperty("PortfolioOwner")]
        public object PortfolioOwner { get; set; }
        [JsonProperty("TeamLead")]
        public object TeamLead { get; set; }
    }
    public class PSP_Metadata
    {
        [JsonProperty("id")]
    ...
    public class AssignmentBaselines
    {
        ...
        public PSP_Deferred Deferred { get; set; }
    }
    public class PSP_Deferred
    {
        [JsonProperty("uri")]
        public string Uri { get; set; }
    }
